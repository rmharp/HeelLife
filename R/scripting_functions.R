      ...
      for (email in emails) {
        ...
        if (length(email_nodes) > 0) {
          ...
          if (length(lines) >= 3) {
            ...
            # Updated regex to handle names with multiple parts, middle initials, hyphens, and parentheses
            # Examples: "Daniela De la Parra", "Daniel M. Ringel", "Rei Sanchez-Arias", "Daiwei (David) Zhang"
